...
void init_can(void){
  ...
  can_set_tx_descriptor_ii(&tx_fd_error, ID_ERROR_COL, CHAN_CAN1, error_get_info, error_get_time);
  can_set_tx_descriptor_fi(&tx_fd_color_white, ID_COL_FRONT_WHITE, CHAN_CAN1, dn_get_color_white, asched_get_timestamp);
  can_set_tx_descriptor_fi(&tx_fd_color_red, ID_COL_FRONT_RED, CHAN_CAN1, dn_get_color_red, asched_get_timestamp);
  can_set_tx_descriptor_fi(&tx_fd_color_green, ID_COL_FRONT_GREEN, CHAN_CAN1, dn_get_color_green, asched_get_timestamp);
  can_set_tx_descriptor_fi(&tx_fd_color_blue, ID_COL_FRONT_BLUE, CHAN_CAN1, dn_get_color_blue, asched_get_timestamp);
  can_set_tx_descriptor_fi(&tx_fd_status, ID_COL_STATUS, CHAN_CAN1, dn_get_status, asched_get_timestamp); 
  can_set_tx_descriptor_fi(&tx_fd_exec_time, ID_COL_EXECUTION_TIME, CHAN_CAN1, dn_get_execution_time, asched_get_timestamp);
  can_set_tx_descriptor_fi(&tx_fd_max_exec_time, ID_COL_MAX_EXECUTION_TIME, CHAN_CAN1, dn_get_max_execution_time, asched_get_timestamp);
