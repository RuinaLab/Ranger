...
CAN_FRAME_DESC tx_fd_rc_2; 
CAN_FRAME_DESC tx_fd_rc_3; 
...
void init_can(void){
  ...
  can_set_tx_descriptor_fi(&tx_fd_rc_2, ID_UI_RC_2, CHAN_CAN2, rcx_get_chan_2, asched_get_timestamp);
  can_set_tx_descriptor_fi(&tx_fd_rc_3, ID_UI_RC_3, CHAN_CAN2, rcx_get_chan_3, asched_get_timestamp);
...
void can_tx_rc2(void){can_transmit(&tx_fd_rc_2);}
void can_tx_rc3(void){can_transmit(&tx_fd_rc_3);}
