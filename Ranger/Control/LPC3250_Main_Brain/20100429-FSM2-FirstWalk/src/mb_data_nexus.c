...
{
  //mb_io_set_ul(ID_UI_SET_LED_1,  0x00800000);
...
{
  // Write new value, if any in error buffer, to ID_ERROR_LABVIEW
  ...
  // Write new value, if any in error buffer, to ID_ERROR_LCD
  ...
  {
    if (lcd_error_push(mb_io_get_pointer(ID_ERROR_MB))) // write new error data if buffer not empty 
    {
      //error - LCD display error buffer full
    }

    if (labview_error_push(mb_io_get_pointer(ID_ERROR_MB))) // write new error data if buffer not empty 
    {
  ...
  {
    if (lcd_error_push(mb_io_get_pointer(ID_ERROR_MCH))) // write new error data if buffer not empty 
    {
      //error - LCD display error buffer full
    }

    if (labview_error_push(mb_io_get_pointer(ID_ERROR_MCH))) // write new error data if buffer not empty 
    {
      //error - LabView display error buffer full
    }
  ...
  {
    if (lcd_error_push(mb_io_get_pointer(ID_ERROR_MCFO))) // write new error data if buffer not empty 
    {
      //error - LCD display error buffer full
    }

    if (labview_error_push(mb_io_get_pointer(ID_ERROR_MCFO))) // write new error data if buffer not empty 
    {
      //error - LabView display error buffer full
    }
  ...
  {
    if (lcd_error_push(mb_io_get_pointer(ID_ERROR_MCFI))) // write new error data if buffer not empty 
    {
      //error - LCD display error buffer full
    }

    if (labview_error_push(mb_io_get_pointer(ID_ERROR_MCFI))) // write new error data if buffer not empty 
    {
      //error - LabView display error buffer full
    }
  ...
  {
    if (lcd_error_push(mb_io_get_pointer(ID_ERROR_MCSO))) // write new error data if buffer not empty 
    {
      //error - LCD display error buffer full
    }

    if (labview_error_push(mb_io_get_pointer(ID_ERROR_MCSO))) // write new error data if buffer not empty 
    {
      //error - LabView display error buffer full
    }
  ...
  {
    if (lcd_error_push(mb_io_get_pointer(ID_ERROR_MCSI))) // write new error data if buffer not empty 
    {
      //error - LCD display error buffer full
    }

    if (labview_error_push(mb_io_get_pointer(ID_ERROR_MCSI))) // write new error data if buffer not empty 
    {
      //error - LabView display error buffer full
    }
  ...
  {
    if (lcd_error_push(mb_io_get_pointer(ID_ERROR_UI))) // write new error data if buffer not empty 
    {
      //error - LCD display error buffer full
    }

    if (labview_error_push(mb_io_get_pointer(ID_ERROR_UI))) // write new error data if buffer not empty 
    {
      //error - LabView display error buffer full
    }
  ...
  {
    if (lcd_error_push(mb_io_get_pointer(ID_ERROR_CSR))) // write new error data if buffer not empty 
    {
      //error - LCD display error buffer full
    }

    if (labview_error_push(mb_io_get_pointer(ID_ERROR_CSR))) // write new error data if buffer not empty 
    {
      //error - LabView display error buffer full
    }
