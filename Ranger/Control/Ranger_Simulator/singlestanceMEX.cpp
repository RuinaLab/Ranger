...
// The following lines are function declarations for the subroutines
...
// Let the games begin. This is the primary function. Typically this would be called main.cpp,
// but for use with dop853 the name vfieldfunc is used instead.
void vfieldfunc(unsigned n,  double t, double* y,  mxArray* params, double* f)
{
	/////////////////////////////////////////////////////////////////////////////////
	//
	// INPUTS:
	//   n  =  the dimension of the state to be integrated
	//   t  =  a scalar time at which the function is being evaluated
	//   y  =  a pointer to an array of doubles, which stores the state (of dimension n)
	//   params  =  a pointer to an array of type mxArray, presumably defined in mex.h
	//               this array contains the parameters that are used in this dynamics function
	//   f  =  a pointer to an array of doubles, which stores the time derivative of y.
	//
	//////////////////////////////////////////////////////////////////////////////////


		// voo-doo magic to convert the mxArray to a double
		double* paramsarray = mxGetPr(params);  

		// Create a bunch of variables that are to be used later
        ...
        int  i, j;
        //int nmat = 8; //nmat should be equal to state space else error 12/10/2009
...
/////////////////////////////////////////////////////////////////////////////////////
//Retrieve parameters from paramsarray
//	
...
////////////////////////////////////////////////////////////////////////////////////
// Unpack parameters into scalars with specific names
//
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
//  Now extract the states from the input state vector
//
...
//
    ...
    Thip = -k*q3; 
    Td_a = -C_st*u1; //-C_st*u2;////changed 2/2/2010
    Td_b = 0;//-C_sw*u4;
    Tatemp = k_st*(q6-q2);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//  Now start re-packing things back up into matricies
//
...
/////////////////////////////////////////////////////////////////////////////////////////////
// 
// The following functions are all little helper subroutines that are called by the main function
//
//////////////////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////////////////
