...
typedef enum can_ids{
	...
	ID_CTRL_HIP_KP = 207,	 // 25 0 1 // 
	ID_CTRL_HIP_KD = 208,	 // 3 0 1 // 
	ID_CTRL_ANK_PUSH_KP = 209,	 // 20 0 1 // 
	ID_CTRL_ANK_PUSH_KD = 210,	 // 2 0 1 // 
	ID_CTRL_ANK_STANCE_KP = 211,	 // 15 0 1 // 
	ID_CTRL_ANK_STANCE_KD = 212,	 // 1 0 1 // 
	ID_CTRL_ANK_SWING_KP = 213,	 // 20 0 1 // 
	ID_CTRL_ANK_SWING_KD = 214,	 // 1 0 1 // 
	ID_CTRL_HIP_COMPENSATION_TARGET = 215,	 // 0 0 1 // hip compensation at target (1) or at measured state (0)
	ID_CTRL_HIP_GRAVITY_COMPENSATION = 216,	 // 1 0 1 // Enables (1) or disables (0) gravity compensation in hip controller
	ID_CTRL_HIP_SPRING_COMPENSATION = 217,	 // 1 0 1 // Enables (1) or disables (0) spring compensation in hip controller
	ID_CTRL_WALK_ANK_PUSH  = 218,	 // 0.8 0 1 // magnitude of the push-off during walking  normalized to be on the range 0 to 1
	ID_CTRL_WALK_CRIT_STANCE_ANGLE = 219,	 // -0.08 0 1 // the critical stance angle when push-off should occur (should be less than zero)
	ID_CTRL_WALK_HIP_STEP_ANGLE  = 220,	 // 0.2 0 1 // Target angle for the hip to hold during push-off
	ID_CTRL_WALK_SCISSOR_GAIN = 221,	 // 1.2 0 1 // 
	ID_CTRL_WALK_SCISSOR_OFFSET = 222,	 // 0.1 0 1 // 
	ID_CTRL_FSM_LED = 223,	 // 0 0 1 // 0 = LED OFF        1 = LED ON
	ID_CTRL_UNIT_TEST_ID = 224,	 // 0 0 1 // Selects which unit test the robot should be running. Default is zero = no test
	...
	ID_GAIT_USE_MDP_DATA = 245,	 // 1 0 1 // true (1) if the robot should use gait parameters from the MDP   and     false(0) if it should use defaults from LabVIEW
	ID_LV_START,	 //    // 
	ID_LV_CH_0,	 //    // 
	ID_LV_CH_1,	 //    // 
	ID_LV_CH_2,	 //    // 
