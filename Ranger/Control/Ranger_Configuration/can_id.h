...
typedef enum can_ids{
	...
	ID_CTRL_HIP_REF_HOLD = 228,	 // 0.2 0 1 // 
	ID_CTRL_HIP_TRANS_ANGLE = 229,	 // 0.08 0 1 // 
	ID_CTRL_ANK_REF_PUSH = 230,	 // -0.9 0 1 // 
	ID_CTRL_ANK_REF_HOLD = 231,	 // 0 0 1 // 
	ID_CTRL_ANK_REF_FLIP = 232,	 // 1.55 0 1 // 
	ID_CTRL_TEST_R0 = 233,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R1 = 234,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R2 = 235,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R3 = 236,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R4 = 237,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R5 = 238,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R6 = 239,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R7 = 240,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R8 = 241,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R9 = 242,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_W0 = 243,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W1 = 244,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W2 = 245,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W3 = 246,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W4 = 247,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W5 = 248,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W6 = 249,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W7 = 250,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W8 = 251,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W9 = 252,	 // 0 1 0 // test write to labview
	ID_LV_START,	 //    // 
	ID_LV_CH_0,	 //    // 
	ID_LV_CH_1,	 //    // 
	ID_LV_CH_2,	 //    // 
