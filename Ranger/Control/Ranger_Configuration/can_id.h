...
typedef enum can_ids{
	...
	ID_EST_TEST_R0 = 187,	 // 0 0 1 // test read from labview
	ID_EST_TEST_R1 = 188,	 // 0 0 1 // test read from labview
	ID_EST_TEST_R2 = 189,	 // 0 0 1 // test read from labview
	ID_EST_TEST_R3 = 190,	 // 0 0 1 // test read from labview
	ID_EST_TEST_R4 = 191,	 // 0 0 1 // test read from labview
	ID_EST_TEST_R5 = 192,	 // 0 0 1 // test read from labview
	ID_EST_TEST_R6 = 193,	 // 0 0 1 // test read from labview
	ID_EST_TEST_R7 = 194,	 // 0 0 1 // test read from labview
	ID_EST_TEST_R8 = 195,	 // 0 0 1 // test read from labview
	ID_EST_TEST_R9 = 196,	 // 0 0 1 // test read from labview
	ID_EST_TEST_W0 = 197,	 // 0 1 0 // test write to labview
	ID_EST_TEST_W1 = 198,	 // 0 1 0 // test write to labview
	ID_EST_TEST_W2 = 199,	 // 0 1 0 // test write to labview
	ID_EST_TEST_W3 = 200,	 // 0 1 0 // test write to labview
	ID_EST_TEST_W4 = 201,	 // 0 1 0 // test write to labview
	ID_EST_TEST_W5 = 202,	 // 0 1 0 // test write to labview
	ID_EST_TEST_W6 = 203,	 // 0 1 0 // test write to labview
	ID_EST_TEST_W7 = 204,	 // 0 1 0 // test write to labview
	ID_EST_TEST_W8 = 205,	 // 0 1 0 // test write to labview
	ID_EST_TEST_W9 = 206,	 // 0 1 0 // test write to labview
	ID_CTRL_HIP_KP = 207,	 // 14 0 1 // 
	ID_CTRL_HIP_KD = 208,	 // 2 0 1 // 
	ID_CTRL_ANK_STANCE_KP = 209,	 // 7 0 1 // 
	ID_CTRL_ANK_STANCE_KD = 210,	 // 1 0 1 // 
	ID_CTRL_ANK_SWING_KP = 211,	 // 7 0 1 // 
	ID_CTRL_ANK_SWING_KD = 212,	 // 1 0 1 // 
	ID_CTRL_HIP_GRAVITY_COMPENSATION = 213,	 // 1 0 1 // Enables (1) or disables (0) gravity compensation in hip controller
	ID_CTRL_HIP_SPRING_COMPENSATION = 214,	 // 1 0 1 // Enables (1) or disables (0) spring compensation in hip controller
	ID_CTRL_FSM_CRIT_STANCE_ANGLE  = 215,	 // 0.1 0 1 // The angle that the stance leg must rotate through to trigger a state transition
	ID_CTRL_WALK_ANK_PUSH  = 216,	 // 0.4 0 1 // magnitude of the push-off during walking  normalized to be on the range 0 to 1
	ID_CTRL_WALK_HIP_RATE  = 217,	 // 1.2 0 1 // scissor tracking rate should be near one 
	ID_CTRL_WALK_HIP_OFFSET  = 218,	 // 0.2 0 1 // How much the swing leg should lead the stance leg during scissor tracking
	ID_CTRL_WALK_HIP_ANGLE  = 219,	 // 0.3 0 1 // Target angle for the hip to hold during push-off
	ID_CTRL_UNIT_TEST_ID = 220,	 // 0 0 1 // Selects which unit test the robot should be running. Default is zero = no test
	ID_CTRL_TEST_R0 = 221,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R1 = 222,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R2 = 223,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R3 = 224,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R4 = 225,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R5 = 226,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R6 = 227,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R7 = 228,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R8 = 229,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R9 = 230,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_W0 = 231,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W1 = 232,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W2 = 233,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W3 = 234,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W4 = 235,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W5 = 236,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W6 = 237,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W7 = 238,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W8 = 239,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W9 = 240,	 // 0 1 0 // test write to labview
	ID_LV_START,	 //    // 
	ID_LV_CH_0,	 //    // 
	ID_LV_CH_1,	 //    // 
	ID_LV_CH_2,	 //    // 
