...
typedef enum can_ids{
	...
	ID_EST_GYRO_ANGLE = 193,	 // 0 1 0 // estimated angle integrated from the rate gyro
	ID_E_MCFO_RIGHT_ANKLE_ANGLE = 194,	 // 0 1 0 // estimated value for outer ankle angle
	ID_E_MCFI_MID_ANKLE_ANGLE = 195,	 // 0 1 0 // estimated value for inner ankle angle
	ID_E_MCFO_RIGHT_ANKLE_RATE = 196,	 // 0 1 0 // estimated value for outer ankle angular rate
	ID_E_MCFI_ANKLE_RATE = 197,	 // 0 1 0 // estimated value for inner ankle angular rate
	ID_EST_TEST_R0 = 198,	 // 0 0 1 // test read from labview
	ID_EST_TEST_R1 = 199,	 // 0 0 1 // test read from labview
	ID_EST_TEST_R2 = 200,	 // 0 0 1 // test read from labview
	ID_EST_TEST_R3 = 201,	 // 0 0 1 // test read from labview
	ID_EST_TEST_R4 = 202,	 // 0 0 1 // test read from labview
	ID_EST_TEST_R5 = 203,	 // 0 0 1 // test read from labview
	ID_EST_TEST_R6 = 204,	 // 0 0 1 // test read from labview
	ID_EST_TEST_R7 = 205,	 // 0 0 1 // test read from labview
	ID_EST_TEST_R8 = 206,	 // 0 0 1 // test read from labview
	ID_EST_TEST_R9 = 207,	 // 0 0 1 // test read from labview
	ID_EST_TEST_W0 = 208,	 // 0 1 0 // test write to labview
	ID_EST_TEST_W1 = 209,	 // 0 1 0 // test write to labview
	ID_EST_TEST_W2 = 210,	 // 0 1 0 // test write to labview
	ID_EST_TEST_W3 = 211,	 // 0 1 0 // test write to labview
	ID_EST_TEST_W4 = 212,	 // 0 1 0 // test write to labview
	ID_EST_TEST_W5 = 213,	 // 0 1 0 // test write to labview
	ID_EST_TEST_W6 = 214,	 // 0 1 0 // test write to labview
	...
	ID_CTRL_HIP_KP = 218,	 // 27 0 1 // 
	ID_CTRL_HIP_KD = 219,	 // 4.8 0 1 // 
	ID_CTRL_ANK_FLIP_KP = 220,	 // 7 0 1 // 
	ID_CTRL_ANK_FLIP_KD = 221,	 // 1 0 1 // 
	ID_CTRL_ANK_PUSH_KP = 222,	 // 7 0 1 // 
	ID_CTRL_ANK_PUSH_KD = 223,	 // 1 0 1 // 
	ID_CTRL_ANK_HOLD_KP = 224,	 // 7 0 1 // 
	ID_CTRL_ANK_HOLD_KD = 225,	 // 1 0 1 // 
	ID_CTRL_HIP_REF_HOLD = 226,	 // 0.2 0 1 // 
	ID_CTRL_HIP_TRANS_ANGLE = 227,	 // 0.08 0 1 // 
	ID_CTRL_ANK_REF_PUSH = 228,	 // -0.75 0 1 // 
	ID_CTRL_ANK_REF_HOLD = 229,	 // 0 0 1 // 
	ID_CTRL_ANK_REF_FLIP = 230,	 // 1.55 0 1 // 
	ID_CTRL_TEST_R0 = 231,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R1 = 232,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R2 = 233,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R3 = 234,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R4 = 235,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R5 = 236,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R6 = 237,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R7 = 238,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R8 = 239,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R9 = 240,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_W0 = 241,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W1 = 242,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W2 = 243,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W3 = 244,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W4 = 245,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W5 = 246,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W6 = 247,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W7 = 248,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W8 = 249,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W9 = 250,	 // 0 1 0 // test write to labview
	ID_LV_START,	 //    // 
	ID_LV_CH_0,	 //    // 
	ID_LV_CH_1,	 //    // 
	ID_LV_CH_2,	 //    // 
