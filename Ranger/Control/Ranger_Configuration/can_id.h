...
typedef enum can_ids{
	...
	ID_CTRL_TEST_R1 = 233,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R2 = 234,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R3 = 235,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R4 = 236,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R5 = 237,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R6 = 238,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R7 = 239,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R8 = 240,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R9 = 241,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_W0 = 242,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W1 = 243,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W2 = 244,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W3 = 245,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W4 = 246,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W5 = 247,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W6 = 248,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W7 = 249,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W8 = 250,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W9 = 251,	 // 0 1 0 // test write to labview
	ID_LV_START,	 //    // 
	ID_LV_CH_0,	 //    // 
	ID_LV_CH_1,	 //    // 
	ID_LV_CH_2,	 //    // 
