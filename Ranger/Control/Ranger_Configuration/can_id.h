...
typedef enum can_ids{
	...
	ID_E_UI_ANG_RATE_X = 174,	 // 0 1 0 // estimated rate of the outer legs (STATE = dqr)
	ID_E_MCH_ANG_RATE = 175,	 // 0 1 0 // estimated rate of the hip (STATE = dqh)
	ID_E_MCFO_RIGHT_ANKLE_RATE  = 176,	 // 0 1 0 // estimated rate of the outer ankles (STATE=dq0)
	ID_E_MCFI_ANKLE_RATE = 177,	 // 0 1 0 // estimated rate of the inner ankles (STATE = dq1)
	ID_EST_CONTACT_OUTER = 178,	 // 0 1 0 // Filtered sum of both outer foot contact sensors
	ID_EST_CONTACT_INNER = 179,	 // 0 1 0 // Filtered sum of both inner foot contact sensors
	ID_EST_LAST_STEP_LENGTH = 180,	 // 0 1 0 // Stores the step length as computed once per step in double stance
	ID_EST_OUTER_LEG_ANGLE = 181,	 // 0 1 0 // absolute angle of the outer legs STATE=(qr)
	ID_EST_TEST_R0 = 182,	 // 0 0 1 // test read from labview
	ID_EST_TEST_R1 = 183,	 // 0 0 1 // test read from labview
	ID_EST_TEST_R2 = 184,	 // 0 0 1 // test read from labview
	ID_EST_TEST_R3 = 185,	 // 0 0 1 // test read from labview
	ID_EST_TEST_R4 = 186,	 // 0 0 1 // test read from labview
	ID_EST_TEST_R5 = 187,	 // 0 0 1 // test read from labview
	ID_EST_TEST_R6 = 188,	 // 0 0 1 // test read from labview
	ID_EST_TEST_R7 = 189,	 // 0 0 1 // test read from labview
	ID_EST_TEST_R8 = 190,	 // 0 0 1 // test read from labview
	ID_EST_TEST_R9 = 191,	 // 0 1 0 // test write to labview
	ID_EST_TEST_W0 = 192,	 // 0 1 0 // test write to labview
	ID_EST_TEST_W1 = 193,	 // 0 1 0 // test write to labview
	ID_EST_TEST_W2 = 194,	 // 0 1 0 // test write to labview
	ID_EST_TEST_W3 = 195,	 // 0 1 0 // test write to labview
	ID_EST_TEST_W4 = 196,	 // 0 1 0 // test write to labview
	ID_EST_TEST_W5 = 197,	 // 0 1 0 // test write to labview
	ID_EST_TEST_W6 = 198,	 // 0 1 0 // test write to labview
	ID_EST_TEST_W7 = 199,	 // 0 1 0 // test write to labview
	ID_EST_TEST_W8 = 200,	 // 0 1 0 // test write to labview
	ID_EST_TEST_W9 = 201,	 //    // 
	ID_CTRL_HIP_KP = 202,	 // 16 0 1 // 
	ID_CTRL_HIP_KD = 203,	 // 3 0 1 // 
	ID_CTRL_ANK_FLIP_KP = 204,	 // 7 0 1 // 
	ID_CTRL_ANK_FLIP_KD = 205,	 // 1 0 1 // 
	ID_CTRL_ANK_PUSH_KP = 206,	 // 20 0 1 // 
	ID_CTRL_ANK_PUSH_KD = 207,	 // 3 0 1 // 
	ID_CTRL_ANK_HOLD_KP = 208,	 // 7 0 1 // 
	ID_CTRL_ANK_HOLD_KD = 209,	 // 1 0 1 // 
	ID_CTRL_HIP_SCISSOR_RATE = 210,	 // 1.3 0 1 // 
	ID_CTRL_HIP_SCISSOR_OFFSET = 211,	 // 0.1 0 1 // 
	ID_CTRL_HIP_REF_HOLD = 212,	 // 0.2 0 1 // 
	ID_CTRL_HIP_TRANS_ANGLE = 213,	 // 0.08 0 1 // 
	ID_CTRL_ANK_REF_PUSH = 214,	 // -0.9 0 1 // 
	ID_CTRL_ANK_REF_HOLD = 215,	 // 0 0 1 // 
	ID_CTRL_ANK_REF_FLIP = 216,	 // 1.55 0 1 // 
