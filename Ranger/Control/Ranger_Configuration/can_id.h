...
typedef enum can_ids{
	...
	ID_OPTIM_OBJ_FUN_SPEED = 207,	 // 0 1 0 // average speed over the last step as determined by the objective function
	ID_OPTIM_FSM_MODE = 208,	 // 0 1 0 // 0 = INIT    1 = PRE_TRIAL    2 = TRIAL    3 = FLYING   
	ID_CTRL_HIP_KP = 209,	 // 25 0 1 // 
	ID_CTRL_HIP_KD = 210,	 // 3 0 1 // 
	ID_CTRL_ANK_PUSH_KP = 211,	 // 20 0 1 // 
	ID_CTRL_ANK_PUSH_KD = 212,	 // 2 0 1 // 
	ID_CTRL_ANK_STANCE_KP = 213,	 // 15 0 1 // 
	ID_CTRL_ANK_STANCE_KD = 214,	 // 1 0 1 // 
	ID_CTRL_ANK_SWING_KP = 215,	 // 20 0 1 // 
	ID_CTRL_ANK_SWING_KD = 216,	 // 1 0 1 // 
	ID_CTRL_HIP_COMPENSATION_TARGET = 217,	 // 0 0 1 // hip compensation at target (1) or at measured state (0)
	ID_CTRL_HIP_GRAVITY_COMPENSATION = 218,	 // 1 0 1 // Enables (1) or disables (0) gravity compensation in hip controller
	ID_CTRL_HIP_SPRING_COMPENSATION = 219,	 // 1 0 1 // Enables (1) or disables (0) spring compensation in hip controller
	ID_CTRL_WALK_ANK_PUSH  = 220,	 // 0.8 0 1 // magnitude of the push-off during walking  normalized to be on the range 0 to 1
	ID_CTRL_WALK_CRIT_STANCE_ANGLE = 221,	 // -0.08 0 1 // the critical stance angle when push-off should occur (should be less than zero)
	ID_CTRL_WALK_HIP_STEP_ANGLE  = 222,	 // 0.2 0 1 // Target angle for the hip to hold during push-off
	ID_CTRL_WALK_SCISSOR_GAIN = 223,	 // 1.2 0 1 // 
	ID_CTRL_WALK_SCISSOR_OFFSET = 224,	 // 0.1 0 1 // 
	ID_CTRL_FSM_LED = 225,	 // 0 0 1 // 0 = LED OFF        1 = LED ON
	ID_CTRL_UNIT_TEST_ID = 226,	 // 0 0 1 // Selects which unit test the robot should be running. Default is zero = no test
	ID_CTRL_TEST_R0 = 227,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R1 = 228,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R2 = 229,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R3 = 230,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R4 = 231,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R5 = 232,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R6 = 233,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R7 = 234,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R8 = 235,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R9 = 236,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_W0 = 237,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W1 = 238,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W2 = 239,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W3 = 240,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W4 = 241,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W5 = 242,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W6 = 243,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W7 = 244,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W8 = 245,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W9 = 246,	 // 0 1 0 // test write to labview
	ID_GAIT_USE_MDP_DATA = 247,	 // 1 0 1 // true (1) if the robot should use gait parameters from the MDP   and     false(0) if it should use defaults from LabVIEW
	ID_LV_START,	 //    // 
	ID_LV_CH_0,	 //    // 
	ID_LV_CH_1,	 //    // 
	ID_LV_CH_2,	 //    // 
