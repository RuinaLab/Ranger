...
typedef enum can_ids{
	...
	ID_CTRL_ANK_PUSH_KD = 196,	 // 3 0 1 // 
	ID_CTRL_ANK_STANCE_KP = 197,	 // 15 0 1 // 
	ID_CTRL_ANK_STANCE_KD = 198,	 // 1 0 1 // 
	ID_CTRL_ANK_SWING_KP = 199,	 // 20 0 1 // 
	ID_CTRL_ANK_SWING_KD = 200,	 // 1 0 1 // 
	ID_CTRL_HIP_COMPENSATION_TARGET = 201,	 // 0 0 1 // hip compensation at target (1) or at measured state (0)
	ID_CTRL_HIP_GRAVITY_COMPENSATION = 202,	 // 1 0 1 // Enables (1) or disables (0) gravity compensation in hip controller
	ID_CTRL_HIP_SPRING_COMPENSATION = 203,	 // 1 0 1 // Enables (1) or disables (0) spring compensation in hip controller
	ID_CTRL_WALK_ANK_PUSH  = 204,	 // 0.8 0 1 // magnitude of the push-off during walking  normalized to be on the range 0 to 1
	ID_CTRL_WALK_CRIT_STANCE_ANGLE = 205,	 // -0.08 0 1 // the critical stance angle when push-off should occur (should be less than zero)
	ID_CTRL_WALK_HIP_STEP_ANGLE  = 206,	 // 0.2 0 1 // Target angle for the hip to hold during push-off
	ID_CTRL_WALK_SCISSOR_GAIN = 207,	 // 1.2 0 1 // 
	ID_CTRL_WALK_SCISSOR_OFFSET = 208,	 // 0.1 0 1 // 
	ID_CTRL_UNIT_TEST_ID = 209,	 // 0 0 1 // Selects which unit test the robot should be running. Default is zero = no test
	ID_CTRL_TEST_R0 = 210,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R1 = 211,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R2 = 212,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R3 = 213,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R4 = 214,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R5 = 215,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R6 = 216,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R7 = 217,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R8 = 218,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R9 = 219,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_W0 = 220,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W1 = 221,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W2 = 222,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W3 = 223,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W4 = 224,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W5 = 225,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W6 = 226,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W7 = 227,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W8 = 228,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W9 = 229,	 // 0 1 0 // test write to labview
	ID_GAIT_WALK_IDX = 230,	 // 0 1 0 // Report the index of the gait parameters being used
