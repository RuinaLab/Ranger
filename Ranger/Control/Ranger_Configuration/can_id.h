...
typedef enum can_ids{
	...
	ID_EST_GYRO_RATE_BIAS = 192,	 // -0.0097 1 0 // estimated bias for the rate gyro - based on experiment on 7/15/2015; the default value does not pass to labview because this parameter writes to labview
	ID_E_MCFO_RIGHT_ANKLE_ANGLE = 193,	 // 0 1 0 // estimated value for outer ankle angle
	ID_E_MCFI_MID_ANKLE_ANGLE = 194,	 // 0 1 0 // estimated value for inner ankle angle
	ID_E_MCFO_RIGHT_ANKLE_RATE = 195,	 // 0 1 0 // estimated value for outer ankle angular rate
	ID_E_MCFI_ANKLE_RATE = 196,	 // 0 1 0 // estimated value for inner ankle angular rate
	ID_EST_TEST_R0 = 197,	 // 0 0 1 // test read from labview
	ID_EST_TEST_R1 = 198,	 // 0 0 1 // test read from labview
	ID_EST_TEST_R2 = 199,	 // 0 0 1 // test read from labview
	ID_EST_TEST_R3 = 200,	 // 0 0 1 // test read from labview
	ID_EST_TEST_R4 = 201,	 // 0 0 1 // test read from labview
	ID_EST_TEST_R5 = 202,	 // 0 0 1 // test read from labview
	ID_EST_TEST_R6 = 203,	 // 0 0 1 // test read from labview
	ID_EST_TEST_R7 = 204,	 // 0 0 1 // test read from labview
	ID_EST_TEST_R8 = 205,	 // 0 0 1 // test read from labview
	ID_EST_TEST_R9 = 206,	 // 0 0 1 // test read from labview
	ID_EST_TEST_W0 = 207,	 // 0 1 0 // test write to labview
	ID_EST_TEST_W1 = 208,	 // 0 1 0 // test write to labview
	ID_EST_TEST_W2 = 209,	 // 0 1 0 // test write to labview
	ID_EST_TEST_W3 = 210,	 // 0 1 0 // test write to labview
	ID_EST_TEST_W4 = 211,	 // 0 1 0 // test write to labview
	ID_EST_TEST_W5 = 212,	 // 0 1 0 // test write to labview
	ID_EST_TEST_W6 = 213,	 // 0 1 0 // test write to labview
	ID_EST_TEST_W7 = 214,	 // 0 1 0 // test write to labview
	ID_EST_TEST_W8 = 215,	 // 0 1 0 // test write to labview
	ID_EST_TEST_W9 = 216,	 // 0 1 0 // test write to labview
	ID_CTRL_HIP_KP = 217,	 // 5 0 1 // 
	ID_CTRL_HIP_KD = 218,	 // 2 0 1 // 
	ID_CTRL_ANK_FLIP_KP = 219,	 // 3 0 1 // 
	ID_CTRL_ANK_FLIP_KD = 220,	 // 0.5 0 1 // 
	ID_CTRL_ANK_PUSH_KP = 221,	 // 3 0 1 // 
	ID_CTRL_ANK_PUSH_KD = 222,	 // 0.5 0 1 // 
	ID_CTRL_ANK_HOLD_KP = 223,	 // 3 0 1 // 
	ID_CTRL_ANK_HOLD_KD = 224,	 // 2.5 0 1 // 
	ID_CTRL_TEST_R0 = 225,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R1 = 226,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R2 = 227,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R3 = 228,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R4 = 229,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R5 = 230,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R6 = 231,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R7 = 232,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R8 = 233,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R9 = 234,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_W0 = 235,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W1 = 236,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W2 = 237,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W3 = 238,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W4 = 239,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W5 = 240,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W6 = 241,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W7 = 242,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W8 = 243,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W9 = 244,	 // 0 1 0 // test write to labview
	ID_LV_START,	 //    // 
	ID_LV_CH_0,	 //    // 
	ID_LV_CH_1,	 //    // 
	ID_LV_CH_2,	 //    // 
