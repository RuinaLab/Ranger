...
typedef enum can_ids{
	...
	ID_CTRL_HIP_KP = 196,	 // 25 0 1 // 
	ID_CTRL_HIP_KD = 197,	 // 3 0 1 // 
	ID_CTRL_ANK_PUSH_KP = 198,	 // 20 0 1 // 
	ID_CTRL_ANK_PUSH_KD = 199,	 // 2 0 1 // 
	ID_CTRL_ANK_STANCE_KP = 200,	 // 15 0 1 // 
	ID_CTRL_ANK_STANCE_KD = 201,	 // 1 0 1 // 
	ID_CTRL_ANK_SWING_KP = 202,	 // 20 0 1 // 
	ID_CTRL_ANK_SWING_KD = 203,	 // 1 0 1 // 
	ID_CTRL_HIP_COMPENSATION_TARGET = 204,	 // 0 0 1 // hip compensation at target (1) or at measured state (0)
	ID_CTRL_HIP_GRAVITY_COMPENSATION = 205,	 // 1 0 1 // Enables (1) or disables (0) gravity compensation in hip controller
	ID_CTRL_HIP_SPRING_COMPENSATION = 206,	 // 1 0 1 // Enables (1) or disables (0) spring compensation in hip controller
	ID_CTRL_WALK_ANK_PUSH  = 207,	 // 0.8 0 1 // magnitude of the push-off during walking  normalized to be on the range 0 to 1
	ID_CTRL_WALK_CRIT_STANCE_ANGLE = 208,	 // -0.08 0 1 // the critical stance angle when push-off should occur (should be less than zero)
	ID_CTRL_WALK_HIP_STEP_ANGLE  = 209,	 // 0.2 0 1 // Target angle for the hip to hold during push-off
	ID_CTRL_WALK_SCISSOR_GAIN = 210,	 // 1.2 0 1 // 
	ID_CTRL_WALK_SCISSOR_OFFSET = 211,	 // 0.1 0 1 // 
	ID_CTRL_UNIT_TEST_ID = 212,	 // 0 0 1 // Selects which unit test the robot should be running. Default is zero = no test
	ID_CTRL_TEST_R0 = 213,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R1 = 214,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R2 = 215,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R3 = 216,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R4 = 217,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R5 = 218,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R6 = 219,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R7 = 220,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R8 = 221,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R9 = 222,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_W0 = 223,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W1 = 224,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W2 = 225,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W3 = 226,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W4 = 227,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W5 = 228,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W6 = 229,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W7 = 230,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W8 = 231,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W9 = 232,	 // 0 1 0 // test write to labview
	ID_GAIT_USE_MDP_DATA = 233,	 // 1 0 1 // true (1) if the robot should use gait parameters from the MDP   and     false(0) if it should use defaults from LabVIEW
	ID_LV_START,	 //    // 
	ID_LV_CH_0,	 //    // 
	ID_LV_CH_1,	 //    // 
	ID_LV_CH_2,	 //    // 
