...
typedef enum can_ids{
	...
	ID_EST_STATE_PSI = 188,	 // 0 1 0 // Steering angle  in radians
	ID_EST_STATE_TH0_GYRO = 189,	 // 0 1 0 // outer leg angle based on integral of rate gyro
	ID_EST_STATE_TH0_IMU = 190,	 // 0 1 0 // outer leg angle based on IMU sensor fusion 
	ID_EST_STATE_POSCOM = 191,	 // 0 1 0 // borizontal component of the center of mass position
	ID_EST_STATE_VELCOM = 192,	 // 0 1 0 // horizontal component of the center of mass velocity
	ID_EST_LAST_STEP_LENGTH = 193,	 // 0 1 0 // step length that was computed at the previous heel-strike
	ID_EST_LAST_STEP_ANGLE = 194,	 // 0 1 0 // the absolute angle of the outer leg that was computed at the previous heel-strike
	ID_EST_LAST_STEP_DURATION = 195,	 // 0 1 0 // Duration of the previous walking step.
	ID_EST_TOTAL_BATT_POWER = 196,	 // 0 1 0 // add up the battery power being consumed by all boards
	ID_OPTIM_WALK_ANK_PUSH  = 197,	 // 0 1 0 // magnitude of the push-off during walking  normalized to be on the range 0 to 1
	ID_OPTIM_WALK_CRIT_STANCE_ANGLE = 198,	 // 0 1 0 // the critical stance angle when push-off should occur (should be less than zero)
	ID_OPTIM_WALK_HIP_STEP_ANGLE  = 199,	 // 0 1 0 // Target angle for the hip to hold during push-off
	ID_OPTIM_WALK_SCISSOR_GAIN = 200,	 // 0 1 0 // 
	ID_OPTIM_WALK_SCISSOR_OFFSET = 201,	 // 0 1 0 // 
	ID_CTRL_HIP_KP = 202,	 // 25 0 1 // 
	ID_CTRL_HIP_KD = 203,	 // 3 0 1 // 
	ID_CTRL_ANK_PUSH_KP = 204,	 // 20 0 1 // 
	ID_CTRL_ANK_PUSH_KD = 205,	 // 2 0 1 // 
	ID_CTRL_ANK_STANCE_KP = 206,	 // 15 0 1 // 
	ID_CTRL_ANK_STANCE_KD = 207,	 // 1 0 1 // 
	ID_CTRL_ANK_SWING_KP = 208,	 // 20 0 1 // 
	ID_CTRL_ANK_SWING_KD = 209,	 // 1 0 1 // 
	ID_CTRL_HIP_COMPENSATION_TARGET = 210,	 // 0 0 1 // hip compensation at target (1) or at measured state (0)
	ID_CTRL_HIP_GRAVITY_COMPENSATION = 211,	 // 1 0 1 // Enables (1) or disables (0) gravity compensation in hip controller
	ID_CTRL_HIP_SPRING_COMPENSATION = 212,	 // 1 0 1 // Enables (1) or disables (0) spring compensation in hip controller
	ID_CTRL_WALK_ANK_PUSH  = 213,	 // 0.8 0 1 // magnitude of the push-off during walking  normalized to be on the range 0 to 1
	ID_CTRL_WALK_CRIT_STANCE_ANGLE = 214,	 // -0.08 0 1 // the critical stance angle when push-off should occur (should be less than zero)
	ID_CTRL_WALK_HIP_STEP_ANGLE  = 215,	 // 0.2 0 1 // Target angle for the hip to hold during push-off
	ID_CTRL_WALK_SCISSOR_GAIN = 216,	 // 1.2 0 1 // 
	ID_CTRL_WALK_SCISSOR_OFFSET = 217,	 // 0.1 0 1 // 
	ID_CTRL_FSM_LED = 218,	 // 0 0 1 // 0 = LED OFF        1 = LED ON
	ID_CTRL_UNIT_TEST_ID = 219,	 // 0 0 1 // Selects which unit test the robot should be running. Default is zero = no test
	ID_CTRL_TEST_R0 = 220,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R1 = 221,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R2 = 222,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R3 = 223,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R4 = 224,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R5 = 225,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R6 = 226,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R7 = 227,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R8 = 228,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R9 = 229,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_W0 = 230,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W1 = 231,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W2 = 232,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W3 = 233,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W4 = 234,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W5 = 235,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W6 = 236,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W7 = 237,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W8 = 238,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W9 = 239,	 // 0 1 0 // test write to labview
	ID_GAIT_USE_MDP_DATA = 240,	 // 1 0 1 // true (1) if the robot should use gait parameters from the MDP   and     false(0) if it should use defaults from LabVIEW
	ID_LV_START,	 //    // 
	ID_LV_CH_0,	 //    // 
	ID_LV_CH_1,	 //    // 
	ID_LV_CH_2,	 //    // 
