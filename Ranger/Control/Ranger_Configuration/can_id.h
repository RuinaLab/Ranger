...
typedef enum can_ids{
	...
	ID_CTRL_HIP_KP = 188,	 // 25 0 1 // 
	ID_CTRL_HIP_KD = 189,	 // 3 0 1 // 
	ID_CTRL_ANK_PUSH_KP = 190,	 // 20 0 1 // 
	ID_CTRL_ANK_PUSH_KD = 191,	 // 3 0 1 // 
	ID_CTRL_ANK_STANCE_KP = 192,	 // 15 0 1 // 
	ID_CTRL_ANK_STANCE_KD = 193,	 // 1 0 1 // 
	ID_CTRL_ANK_SWING_KP = 194,	 // 20 0 1 // 
	ID_CTRL_ANK_SWING_KD = 195,	 // 1 0 1 // 
	ID_CTRL_HIP_COMPENSATION_TARGET = 196,	 // 0 0 1 // hip compensation at target (1) or at measured state (0)
	ID_CTRL_HIP_GRAVITY_COMPENSATION = 197,	 // 1 0 1 // Enables (1) or disables (0) gravity compensation in hip controller
	ID_CTRL_HIP_SPRING_COMPENSATION = 198,	 // 1 0 1 // Enables (1) or disables (0) spring compensation in hip controller
	ID_CTRL_WALK_ANK_PUSH  = 199,	 // 0.8 0 1 // magnitude of the push-off during walking  normalized to be on the range 0 to 1
	ID_CTRL_WALK_CRIT_STANCE_ANGLE = 200,	 // -0.08 0 1 // the critical stance angle when push-off should occur (should be less than zero)
	ID_CTRL_WALK_HIP_STEP_ANGLE  = 201,	 // 0.2 0 1 // Target angle for the hip to hold during push-off
	ID_CTRL_WALK_SCISSOR_GAIN = 202,	 // 1.2 0 1 // 
	ID_CTRL_WALK_SCISSOR_OFFSET = 203,	 // 0.1 0 1 // 
	ID_CTRL_UNIT_TEST_ID = 204,	 // 0 0 1 // Selects which unit test the robot should be running. Default is zero = no test
	ID_CTRL_TEST_R0 = 205,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R1 = 206,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R2 = 207,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R3 = 208,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R4 = 209,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R5 = 210,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R6 = 211,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R7 = 212,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R8 = 213,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R9 = 214,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_W0 = 215,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W1 = 216,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W2 = 217,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W3 = 218,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W4 = 219,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W5 = 220,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W6 = 221,	 // 0 1 0 // test write to labview
