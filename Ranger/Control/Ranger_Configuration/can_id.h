...
typedef enum can_ids{
	...
	ID_E_MCH_ANG_RATE = 174,	 // 0 1 0 // estimated slightly filtered derivative of ID_MCH_ANGLE
	ID_E_MCFI_LEFT_HEEL_SENSE = 175,	 // 0 1 0 // estimated value for the sensor on the inner left foot  
	ID_E_MCFI_RIGHT_HEEL_SENSE = 176,	 // 0 1 0 // estimated value for the sensor on the inner right foot  
	ID_E_MCFO_LEFT_HEEL_SENSE = 177,	 // 0 1 0 // estimated value for the sensor on the outer left foot  
	ID_E_MCFO_RIGHT_HEEL_SENSE = 178,	 // 0 1 0 // estimated value for the sensor on the outer right foot  
	ID_E_UI_ANG_RATE_X = 179,	 // 0 1 0 // estimated value for gyro rate
	ID_E_MCFO_RIGHT_ANKLE_ANGLE = 180,	 // 0 1 0 // 
	ID_E_MCFI_MID_ANKLE_ANGLE = 181,	 // 0 1 0 // estimated angle integrated from the rate gyro
	ID_E_MCFO_RIGHT_ANKLE_RATE = 182,	 // 0 1 0 // estimated value for outer ankle angle
	ID_E_MCFI_ANKLE_RATE = 183,	 // 0 1 0 // estimated value for inner ankle angle
	ID_EST_CONTACT_OUTER = 184,	 // 0 1 0 // Filtered sum of both outer foot contact sensors
	ID_EST_CONTACT_INNER = 185,	 // 0 1 0 // Filtered sum of both inner foot contact sensors
	ID_EST_OUTER_LEG_ANGLE = 186,	 // 0 1 0 // Estimated orientation of the gyro on the outer legs
	ID_EST_LAST_STEP_LENGTH = 187,	 // 0 1 0 // Stores the step length as computed once per step in double stance
	...
	ID_EST_TEST_W9 = 207,	 //    // 
	ID_CTRL_HIP_KP = 208,	 // 3 0 1 // 
	ID_CTRL_HIP_KD = 209,	 // 7 0 1 // 
	ID_CTRL_ANK_FLIP_KP = 210,	 // 1 0 1 // 
	ID_CTRL_ANK_FLIP_KD = 211,	 // 20 0 1 // 
	ID_CTRL_ANK_PUSH_KP = 212,	 // 3 0 1 // 
	ID_CTRL_ANK_PUSH_KD = 213,	 // 7 0 1 // 
	ID_CTRL_ANK_HOLD_KP = 214,	 // 1 0 1 // 
	ID_CTRL_ANK_HOLD_KD = 215,	 // 1.3 0 1 // 
	ID_CTRL_HIP_SCISSOR_RATE = 216,	 // 0.1 0 1 // 
	ID_CTRL_HIP_SCISSOR_OFFSET = 217,	 // 0.2 0 1 // 
	ID_CTRL_HIP_REF_HOLD = 218,	 // 0.08 0 1 // 
	ID_CTRL_HIP_TRANS_ANGLE = 219,	 // -0.9 0 1 // 
	ID_CTRL_ANK_REF_PUSH = 220,	 // 0 0 1 // 
	ID_CTRL_ANK_REF_HOLD = 221,	 // 1.55 0 1 // 
	ID_CTRL_ANK_REF_FLIP = 222,	 //    // 
