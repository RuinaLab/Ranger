...
typedef enum can_ids{
	...
	ID_EST_ROBOT_ANGLE_GYRO_WEIGHT = 188,	 // 0.9 0 1 // Trade-off between rate gyro and double stance geometry for robot orientation sensing 0 is total reset 1 is ignore geometry
	...
	ID_EST_TEST_R3 = 192,	 // 0 0 1 // test read from labview
	ID_EST_TEST_R4 = 193,	 // 0 0 1 // test read from labview
	ID_EST_TEST_R5 = 194,	 // 0 0 1 // test read from labview
	...
	ID_EST_TEST_W3 = 202,	 // 0 1 0 // test write to labview
	ID_EST_TEST_W4 = 203,	 // 0 1 0 // test write to labview
	ID_EST_TEST_W5 = 204,	 // 0 1 0 // test write to labview
	...
	ID_EST_TEST_W9 = 208,	 //    // 
	ID_CTRL_HIP_KP = 209,	 // 16 0 1 // 
	ID_CTRL_HIP_KD = 210,	 // 3 0 1 // 
	ID_CTRL_ANK_FLIP_KP = 211,	 // 7 0 1 // 
	ID_CTRL_ANK_FLIP_KD = 212,	 // 1 0 1 // 
	ID_CTRL_ANK_PUSH_KP = 213,	 // 20 0 1 // 
	ID_CTRL_ANK_PUSH_KD = 214,	 // 3 0 1 // 
	ID_CTRL_ANK_HOLD_KP = 215,	 // 7 0 1 // 
	ID_CTRL_ANK_HOLD_KD = 216,	 // 1 0 1 // 
	ID_CTRL_HIP_SCISSOR_RATE = 217,	 // 1.3 0 1 // 
	ID_CTRL_HIP_SCISSOR_OFFSET = 218,	 // 0.1 0 1 // 
	ID_CTRL_HIP_REF_HOLD = 219,	 // 0.2 0 1 // 
	ID_CTRL_HIP_TRANS_ANGLE = 220,	 // 0.08 0 1 // 
	ID_CTRL_ANK_REF_PUSH = 221,	 // -0.9 0 1 // 
	...
	ID_CTRL_TEST_R0 = 224,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R1 = 225,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R2 = 226,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R3 = 227,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R4 = 228,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R5 = 229,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R6 = 230,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R7 = 231,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R8 = 232,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R9 = 233,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W0 = 234,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W1 = 235,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W2 = 236,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W3 = 237,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W4 = 238,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W5 = 239,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W6 = 240,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W7 = 241,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W8 = 242,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W9 = 243,	 //    // 
	ID_LV_START,	 //    // 
	ID_LV_CH_0,	 //    // 
	ID_LV_CH_1,	 //    // 
