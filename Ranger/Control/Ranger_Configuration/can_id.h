...
typedef enum can_ids{
	...
	ID_E_MCFI_LEFT_HEEL_SENSE = 188,	 // 0 1 0 // estimated value for the sensor on the inner left foot  
	ID_E_MCFI_RIGHT_HEEL_SENSE = 189,	 // 0 1 0 // estimated value for the sensor on the inner right foot  
	ID_E_MCFO_LEFT_HEEL_SENSE = 190,	 // 0 1 0 // estimated value for the sensor on the outer left foot  
	ID_E_MCFO_RIGHT_HEEL_SENSE = 191,	 // 0 1 0 // estimated value for the sensor on the outer right foot  
	ID_E_UI_ANG_RATE_X = 192,	 // 0 1 0 // estimated value for gyro rate
	ID_EST_GYRO_RATE_BIAS = 193,	 // -0.0097 1 0 // estimated bias for the rate gyro - based on experiment on 7/15/2015; the default value does not pass to labview because this parameter writes to labview
	ID_EST_GYRO_ANGLE = 194,	 // 0 1 0 // estimated angle integrated from the rate gyro
	ID_E_MCFO_RIGHT_ANKLE_ANGLE = 195,	 // 0 1 0 // estimated value for outer ankle angle
	ID_E_MCFI_MID_ANKLE_ANGLE = 196,	 // 0 1 0 // estimated value for inner ankle angle
	ID_E_MCFO_RIGHT_ANKLE_RATE = 197,	 // 0 1 0 // estimated value for outer ankle angular rate
	ID_E_MCFI_ANKLE_RATE = 198,	 // 0 1 0 // estimated value for inner ankle angular rate
	ID_EST_TEST_R0 = 199,	 // 0 0 1 // test read from labview
	ID_EST_TEST_R1 = 200,	 // 0 0 1 // test read from labview
	ID_EST_TEST_R2 = 201,	 // 0 0 1 // test read from labview
	ID_EST_TEST_R3 = 202,	 // 0 0 1 // test read from labview
	ID_EST_TEST_R4 = 203,	 // 0 0 1 // test read from labview
	ID_EST_TEST_R5 = 204,	 // 0 0 1 // test read from labview
	ID_EST_TEST_R6 = 205,	 // 0 0 1 // test read from labview
	ID_EST_TEST_R7 = 206,	 // 0 0 1 // test read from labview
	ID_EST_TEST_R8 = 207,	 // 0 0 1 // test read from labview
	ID_EST_TEST_R9 = 208,	 // 0 0 1 // test read from labview
	ID_EST_TEST_W0 = 209,	 // 0 1 0 // test write to labview
	ID_EST_TEST_W1 = 210,	 // 0 1 0 // test write to labview
	ID_EST_TEST_W2 = 211,	 // 0 1 0 // test write to labview
	ID_EST_TEST_W3 = 212,	 // 0 1 0 // test write to labview
	ID_EST_TEST_W4 = 213,	 // 0 1 0 // test write to labview
	ID_EST_TEST_W5 = 214,	 // 0 1 0 // test write to labview
	ID_EST_TEST_W6 = 215,	 // 0 1 0 // test write to labview
	ID_EST_TEST_W7 = 216,	 // 0 1 0 // test write to labview
	ID_EST_TEST_W8 = 217,	 // 0 1 0 // test write to labview
	ID_EST_TEST_W9 = 218,	 // 0 1 0 // test write to labview
	ID_EST_DEFAULT_GYRO_BIAS = 219,	 // -0.0097 0 1 // 
	ID_CTRL_HIP_KP = 220,	 // 16 0 1 // 
	ID_CTRL_HIP_KD = 221,	 // 3 0 1 // 
	ID_CTRL_ANK_FLIP_KP = 222,	 // 7 0 1 // 
	ID_CTRL_ANK_FLIP_KD = 223,	 // 1 0 1 // 
	ID_CTRL_ANK_PUSH_KP = 224,	 // 20 0 1 // 
	ID_CTRL_ANK_PUSH_KD = 225,	 // 3 0 1 // 
	ID_CTRL_ANK_HOLD_KP = 226,	 // 7 0 1 // 
	ID_CTRL_ANK_HOLD_KD = 227,	 // 1 0 1 // 
	ID_CTRL_HIP_SCISSOR_RATE = 228,	 // 1.3 0 1 // 
	ID_CTRL_HIP_SCISSOR_OFFSET = 229,	 // 0.1 0 1 // 
	ID_CTRL_HIP_REF_HOLD = 230,	 // 0.2 0 1 // 
	ID_CTRL_HIP_TRANS_ANGLE = 231,	 // 0.08 0 1 // 
	ID_CTRL_ANK_REF_PUSH = 232,	 // -0.9 0 1 // 
	ID_CTRL_ANK_REF_HOLD = 233,	 // 0 0 1 // 
	ID_CTRL_ANK_REF_FLIP = 234,	 // 1.55 0 1 // 
	ID_CTRL_TEST_R0 = 235,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R1 = 236,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R2 = 237,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R3 = 238,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R4 = 239,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R5 = 240,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R6 = 241,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R7 = 242,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R8 = 243,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R9 = 244,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_W0 = 245,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W1 = 246,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W2 = 247,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W3 = 248,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W4 = 249,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W5 = 250,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W6 = 251,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W7 = 252,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W8 = 253,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W9 = 254,	 // 0 1 0 // test write to labview
	ID_LV_START,	 //    // 
	ID_LV_CH_0,	 //    // 
	ID_LV_CH_1,	 //    // 
	ID_LV_CH_2,	 //    // 
