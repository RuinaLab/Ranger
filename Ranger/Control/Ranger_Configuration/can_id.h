...
typedef enum can_ids{
	...
	ID_CTRL_TEST_R0 = 209,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R1 = 210,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R2 = 211,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R3 = 212,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R4 = 213,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R5 = 214,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R6 = 215,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R7 = 216,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R8 = 217,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R9 = 218,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_W0 = 219,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W1 = 220,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W2 = 221,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W3 = 222,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W4 = 223,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W5 = 224,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W6 = 225,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W7 = 226,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W8 = 227,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W9 = 228,	 // 0 1 0 // test write to labview
	ID_LV_START,	 //    // 
	ID_LV_CH_0,	 //    // 
	ID_LV_CH_1,	 //    // 
	ID_LV_CH_2,	 //    // 
