...
typedef enum can_ids{
	...
	ID_CTRL_TEST_R0 = 226,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R1 = 227,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R2 = 228,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R3 = 229,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R4 = 230,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R5 = 231,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R6 = 232,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R7 = 233,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R8 = 234,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R9 = 235,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_W0 = 236,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W1 = 237,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W2 = 238,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W3 = 239,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W4 = 240,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W5 = 241,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W6 = 242,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W7 = 243,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W8 = 244,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W9 = 245,	 // 0 1 0 // test write to labview
	ID_LV_START,	 //    // 
	ID_LV_CH_0,	 //    // 
	ID_LV_CH_1,	 //    // 
	ID_LV_CH_2,	 //    // 
