...
typedef enum can_ids{
	...
	ID_EST_STATE_POSCOM = 190,	 // 0 1 0 // borizontal component of the center of mass position
	ID_EST_STATE_VELCOM = 191,	 // 0 1 0 // horizontal component of the center of mass velocity
	ID_EST_LAST_STEP_LENGTH = 192,	 // 0 1 0 // step length that was computed at the previous heel-strike
	ID_EST_LAST_STEP_ANGLE = 193,	 // 0 1 0 // the absolute angle of the outer leg that was computed at the previous heel-strike
	ID_EST_LAST_STEP_DURATION = 194,	 // 0 1 0 // Duration of the previous walking step.
	ID_EST_TOTAL_BATT_POWER = 195,	 // 0 1 0 // add up the battery power being consumed by all boards
	ID_OPTIM_WALK_ANK_PUSH  = 196,	 // 0 1 0 // magnitude of the push-off during walking  normalized to be on the range 0 to 1
	ID_OPTIM_WALK_CRIT_STANCE_ANGLE = 197,	 // 0 1 0 // the critical stance angle when push-off should occur (should be less than zero)
	ID_OPTIM_WALK_HIP_STEP_ANGLE  = 198,	 // 0 1 0 // Target angle for the hip to hold during push-off
	ID_OPTIM_WALK_SCISSOR_GAIN = 199,	 // 0 1 0 // 
	ID_OPTIM_WALK_SCISSOR_OFFSET = 200,	 // 0 1 0 // 
	ID_CTRL_HIP_KP = 201,	 // 25 0 1 // 
	ID_CTRL_HIP_KD = 202,	 // 3 0 1 // 
	ID_CTRL_ANK_PUSH_KP = 203,	 // 20 0 1 // 
	ID_CTRL_ANK_PUSH_KD = 204,	 // 2 0 1 // 
	ID_CTRL_ANK_STANCE_KP = 205,	 // 15 0 1 // 
	ID_CTRL_ANK_STANCE_KD = 206,	 // 1 0 1 // 
	ID_CTRL_ANK_SWING_KP = 207,	 // 20 0 1 // 
	ID_CTRL_ANK_SWING_KD = 208,	 // 1 0 1 // 
	ID_CTRL_HIP_COMPENSATION_TARGET = 209,	 // 0 0 1 // hip compensation at target (1) or at measured state (0)
	ID_CTRL_HIP_GRAVITY_COMPENSATION = 210,	 // 1 0 1 // Enables (1) or disables (0) gravity compensation in hip controller
	ID_CTRL_HIP_SPRING_COMPENSATION = 211,	 // 1 0 1 // Enables (1) or disables (0) spring compensation in hip controller
	ID_CTRL_WALK_ANK_PUSH  = 212,	 // 0.8 0 1 // magnitude of the push-off during walking  normalized to be on the range 0 to 1
	ID_CTRL_WALK_CRIT_STANCE_ANGLE = 213,	 // -0.08 0 1 // the critical stance angle when push-off should occur (should be less than zero)
	ID_CTRL_WALK_HIP_STEP_ANGLE  = 214,	 // 0.2 0 1 // Target angle for the hip to hold during push-off
	ID_CTRL_WALK_SCISSOR_GAIN = 215,	 // 1.2 0 1 // 
	ID_CTRL_WALK_SCISSOR_OFFSET = 216,	 // 0.1 0 1 // 
	ID_CTRL_FSM_LED = 217,	 // 0 0 1 // 0 = LED OFF        1 = LED ON
	ID_CTRL_UNIT_TEST_ID = 218,	 // 0 0 1 // Selects which unit test the robot should be running. Default is zero = no test
	ID_CTRL_TEST_R0 = 219,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R1 = 220,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R2 = 221,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R3 = 222,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R4 = 223,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R5 = 224,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R6 = 225,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R7 = 226,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R8 = 227,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R9 = 228,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_W0 = 229,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W1 = 230,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W2 = 231,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W3 = 232,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W4 = 233,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W5 = 234,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W6 = 235,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W7 = 236,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W8 = 237,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W9 = 238,	 // 0 1 0 // test write to labview
	ID_GAIT_USE_MDP_DATA = 239,	 // 1 0 1 // true (1) if the robot should use gait parameters from the MDP   and     false(0) if it should use defaults from LabVIEW
	ID_LV_START,	 //    // 
	ID_LV_CH_0,	 //    // 
	ID_LV_CH_1,	 //    // 
	ID_LV_CH_2,	 //    // 
