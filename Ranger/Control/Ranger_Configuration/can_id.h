...
typedef enum can_ids{
	...
	ID_EST_ROBOT_ANGLE_GYRO_WEIGHT = 188,	 // 0.5 0 1 // Trade-off between rate gyro and double stance geometry for robot orientation sensing 0 is total reset 1 is ignore geometry
	...
	ID_CTRL_ANK_SWING_KP = 213,	 // 7 0 1 // 
	...
	ID_CTRL_WALK_ANK_PUSH  = 218,	 // 0.4 0 1 // magnitude of the push-off during walking  normalized to be on the range 0 to 1
	ID_CTRL_WALK_HIP_RATE  = 219,	 // 1.2 0 1 // scissor tracking rate should be near one 
	ID_CTRL_WALK_HIP_OFFSET  = 220,	 // 0.2 0 1 // How much the swing leg should lead the stance leg during scissor tracking
	ID_CTRL_WALK_HIP_ANGLE  = 221,	 // 0.3 0 1 // Target angle for the hip to hold during push-off
