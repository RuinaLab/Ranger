...
typedef enum can_ids{
	...
	ID_E_MCH_MOTOR_VELOCITY = 174,	 // 0 1 0 // estimated angular rate (rad/sec) of hip motor
	ID_E_MCH_ANG_RATE = 175,	 // 0 1 0 // estimated slightly filtered derivative of ID_MCH_ANGLE
	ID_E_MCFI_LEFT_HEEL_SENSE = 176,	 // 0 1 0 // estimated value for the sensor on the inner left foot  
	ID_E_MCFI_RIGHT_HEEL_SENSE = 177,	 // 0 1 0 // estimated value for the sensor on the inner right foot  
	ID_E_MCFO_LEFT_HEEL_SENSE = 178,	 // 0 1 0 // estimated value for the sensor on the outer left foot  
	ID_E_MCFO_RIGHT_HEEL_SENSE = 179,	 // 0 1 0 // estimated value for the sensor on the outer right foot  
	ID_E_UI_ANG_RATE_X = 180,	 // 0 1 0 // estimated value for gyro rate
	ID_E_MCFO_RIGHT_ANKLE_ANGLE = 181,	 // 0 1 0 // 
	ID_E_MCFI_MID_ANKLE_ANGLE = 182,	 // 0 1 0 // estimated angle integrated from the rate gyro
	ID_E_MCFO_RIGHT_ANKLE_RATE = 183,	 // 0 1 0 // estimated value for outer ankle angle
	ID_E_MCFI_ANKLE_RATE = 184,	 // 0 1 0 // estimated value for inner ankle angle
	ID_EST_GYRO_ANGLE = 185,	 // 0 1 0 // 
	ID_EST_LAST_STEP_LENGTH = 186,	 // 0 1 0 // Stores the step length as computed once per step in double stance
	...
	ID_EST_TEST_R9 = 196,	 // 0 1 0 // test write to labview
	...
	ID_EST_TEST_W9 = 206,	 //    // 
	ID_CTRL_HIP_KP = 207,	 // 3 0 1 // 
	ID_CTRL_HIP_KD = 208,	 // 7 0 1 // 
	ID_CTRL_ANK_FLIP_KP = 209,	 // 1 0 1 // 
	ID_CTRL_ANK_FLIP_KD = 210,	 // 20 0 1 // 
	ID_CTRL_ANK_PUSH_KP = 211,	 // 3 0 1 // 
	ID_CTRL_ANK_PUSH_KD = 212,	 // 7 0 1 // 
	ID_CTRL_ANK_HOLD_KP = 213,	 // 1 0 1 // 
	ID_CTRL_ANK_HOLD_KD = 214,	 // 1.3 0 1 // 
	ID_CTRL_HIP_SCISSOR_RATE = 215,	 // 0.1 0 1 // 
	ID_CTRL_HIP_SCISSOR_OFFSET = 216,	 // 0.2 0 1 // 
	ID_CTRL_HIP_REF_HOLD = 217,	 // 0.08 0 1 // 
	ID_CTRL_HIP_TRANS_ANGLE = 218,	 // -0.9 0 1 // 
	ID_CTRL_ANK_REF_PUSH = 219,	 // 0 0 1 // 
	ID_CTRL_ANK_REF_HOLD = 220,	 // 1.55 0 1 // 
	ID_CTRL_ANK_REF_FLIP = 221,	 //    // 
	ID_CTRL_TEST_R0 = 222,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R1 = 223,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R2 = 224,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R3 = 225,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R4 = 226,	 // 0 0 1 // test read from labview
	ID_CTRL_TEST_R5 = 227,	 // 0 0 1 // test read from labview
	...
	ID_CTRL_TEST_W3 = 235,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W4 = 236,	 // 0 1 0 // test write to labview
	ID_CTRL_TEST_W5 = 237,	 // 0 1 0 // test write to labview
