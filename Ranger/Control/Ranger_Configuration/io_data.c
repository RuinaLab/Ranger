...
mb_io_data[ID_CTRL_WALK_CRIT_STANCE_ANGLE].payload.ful.f = -0.080000; 
mb_io_data[ID_CTRL_WALK_HIP_STEP_ANGLE ].payload.ful.f = 0.200000; 
mb_io_data[ID_CTRL_WALK_SCISSOR_GAIN].payload.ful.f = 1.200000; 
mb_io_data[ID_CTRL_WALK_SCISSOR_OFFSET].payload.ful.f = 0.100000; 
mb_io_data[ID_CTRL_WALK_PUSH_TIME].payload.ful.f = 0.050000; 
