...
// commented for testing of switching between two steering signals; Petr -- 2/1/13 
//  float rc_command = 0.00004*get_io_float(ID_UI_RC_0)- 3.4; //A number between -1 and 1
            ...
            float rc_command = 0.0;
            if (0.0000417*get_io_float(ID_UI_RC_2)-3.75 < -0.1)   // switch is at the front position, use right joystick
                { rc_command = 0.0000417*get_io_float(ID_UI_RC_0)- 3.75; } //A number between -1 and 1
            else    // switch is at the back position, use left joystick
                { rc_command = 0.0000417*get_io_float(ID_UI_RC_1)- 3.75; } //A number between -1 and 1
