...
enum conditions { COND_UI_standby_to_calibrate, 
                  ...
                  COND_UI_stop,
                  COND_UI_calibrate_to_rock,
                  COND_UI_standby_to_rock,
                  COND_UI_rock_to_standby,
                  COND_UI_rock_to_walk,
                };
...
{}
 ...
 {  
  ...
  if (detect_UI_button_input(1))  //button number of <walk> is 1
  {
    ...
    sensor_array[COND_UI_rock_to_walk] = 1;
  }
  
  if (detect_UI_button_input(2))  //button number of <standby> is 2
  {
    sensor_array[COND_UI_walk_to_standby] = 1;
    sensor_array[COND_UI_rock_to_standby] = 1;
  }
  
  if (detect_UI_button_input(3))  //button number of <rock> is 3
  {
  sensor_array[COND_UI_calibrate_to_rock] = 1;
  sensor_array[COND_UI_standby_to_rock] = 1;
  }
 ...
 if (get_io_float(ID_P_R_ROCK_TO_WALK)) //rock sequence is over, begin walk
  {
    sensor_array[COND_UI_rock_to_walk] = 1;
  }
