...
int g_ui_fsm_state;
int g_leg_fsm_state;
int g_rock_hip_fsm_state;
int g_rock_foot_inner_fsm_state;
int g_rock_foot_outer_fsm_state;
...
fsm* rock_hip_fsm;
fsm* rock_foot_inner_fsm;
fsm* rock_foot_outer_fsm;
...
ui_fsm = new fsm();
leg_fsm = new fsm();
rock_hip_fsm = new fsm();
rock_foot_inner_fsm = new fsm();
rock_foot_outer_fsm = new fsm();
...
def_UI_fsm(ui_fsm);
def_leg_fsm(leg_fsm);
def_rock_hip_fsm(rock_hip_fsm);        
def_rock_foot_inner_fsm(rock_foot_inner_fsm);
def_rock_foot_outer_fsm(rock_foot_outer_fsm);
...
ui_fsm->check(1);
leg_fsm->check(1);
rock_hip_fsm->check(1);
rock_foot_inner_fsm->check(1);
rock_foot_outer_fsm->check(1);
