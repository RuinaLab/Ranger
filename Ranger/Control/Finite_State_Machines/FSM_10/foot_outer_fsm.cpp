...
fsm1.state_def(STATE_FO_stopstance, ACT_FO_stopstance_entry, ACT_FO_stopstance, ACT_FO_stopstance); //Stop stance
...
//Allow to transition to startstance from all states 
...
fsm1.trans_def(STATE_FO_stopstance, COND_FO_startstance, STATE_FO_startstance);
fsm1.trans_def(STATE_FO_startafterpush, COND_FO_startstance, STATE_FO_startstance);

fsm1.trans_def(STATE_FO_stance, COND_FO_stance_to_stopstance, STATE_FO_stopstance); //Stop stance transition 
fsm1.trans_def(STATE_FO_prepush, COND_FO_prepush_to_stopstance, STATE_FO_stopstance);
fsm1.trans_def(STATE_FO_stopstance, COND_FO_stopstance_to_startafterpush, STATE_FO_startafterpush); //Start in afterpush from stopping
...
//This assignment is done in ui_fsm
