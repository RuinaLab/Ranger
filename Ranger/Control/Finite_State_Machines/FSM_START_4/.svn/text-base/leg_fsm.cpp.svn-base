...
fsm1.state_def(STATE_LI_preswing, ACT_LI_preswing_entry, ACT_LI_preswing, ACT_LI_preswing_exit);
fsm1.state_def(STATE_LI_premid, ACT_LI_premid_entry, ACT_LI_premid, ACT_LI_premid);
fsm1.state_def(STATE_LI_aftermid, ACT_LI_aftermid_entry, ACT_LI_aftermid, ACT_LI_aftermid_exit);
fsm1.state_def(STATE_LO_preswing, ACT_LO_preswing_entry, ACT_LO_preswing, ACT_LO_preswing_exit);
fsm1.state_def(STATE_LO_premid, ACT_LO_premid_entry, ACT_LO_premid, ACT_LO_premid);
fsm1.state_def(STATE_LO_aftermid, ACT_LO_aftermid_entry, ACT_LO_aftermid, ACT_LO_aftermid_exit);
