...
typedef enum can_ids{
	...
	ID_E_TEST1 = 195,	 //0 1 0 dummy for testing
	ID_E_TEST2 = 196,	 //0 1 0 dummy for testing
	ID_E_TEST3 = 197,	 //0 1 0 dummy for testing
	ID_A_H_PM_A0 = 198,	 //0 0 1 
	ID_A_H_PM_A1 = 199,	 //0 0 1 
	ID_C_HI_SH_H_ANG = 200,	 //0 0 1 
	ID_C_HI_SH_H_RATE = 201,	 //0 0 1 
	ID_C_H_EH_H_ANG = 202,	 //0 0 1 
	ID_C_H_EH_H_RATE = 203,	 //0 0 1 
	ID_P_HI_SH_H_TANG = 204,	 //0 0 1 
	ID_P_H_EH_H_TANG = 205,	 //0 0 1 
	ID_P_H_EHOLD_ANG = 206,	 //0 0 1 
	ID_A_H_TEST_A0 = 207,	 //0 0 1 
	ID_H_TEST1 = 208,	 //0 0 1 dummy for testing hip
	ID_H_TEST2 = 209,	 //0 0 1 dummy for testing hip
	ID_H_TEST3 = 210,	 //0 0 1 dummy for testing hip
	ID_C_F_ST_F_ANG = 211,	 //0 0 1 
	ID_C_F_ST_F_RATE = 212,	 //0 0 1 
	ID_C_F_PP_F_ANG = 213,	 //0 0 1 
	ID_C_F_PP_F_RATE = 214,	 //0 0 1 
	ID_C_F_FU_F_ANG = 215,	 //4 0 1 
	ID_C_F_FU_F_RATE = 216,	 //0.2 0 1 
	ID_C_F_FD_F_ANG = 217,	 //4 0 1 
	ID_C_F_FD_F_RATE = 218,	 //0.2 0 1 
	ID_C_F_SST_F_ANG = 219,	 //0 0 1 
	ID_C_F_SST_F_RATE = 220,	 //0 0 1 
	ID_P_F_PP_L_ABSANG = 221,	 //0 0 1 
	ID_P_F_FU_H_ANG = 222,	 //0.1 0 1 
	ID_P_F_FU_F_TANG = 223,	 //0.2 0 1 
	ID_P_F_ST_F_TANG = 224,	 //0 0 1 
	ID_P_F_PP_F_TANG = 225,	 //0 0 1 
	ID_P_F_FD_F_TANG = 226,	 //1.8 0 1 
	ID_P_F_SST_F_TANG = 227,	 //0 0 1 
	ID_P_F_S_H_ANG = 228,	 //0.05 0 1 
	ID_F_TEST1 = 229,	 //0 0 1 dummy for testing feet
	ID_F_TEST2 = 230,	 //0 0 1 dummy for testing feet
	ID_F_TEST3 = 231,	 //0 0 1 dummy for testing feet
	ID_F_TEST4 = 232,	 //0 0 1 dummy for testing feet
	ID_F_TEST5 = 233,	 //0 0 1 dummy for testing feet
	ID_P_S_NULL_S_TANG = 234,	 //0 0 1 
	ID_P_S_ILST_S_MAXANG = 235,	 //0 0 1 
	ID_P_S_ILSW_S_MAXANG = 236,	 //0 0 1 
	ID_P_S_TEMP_S_TANG = 237,	 //0 0 1 
	ID_C_S_NULL_S_ANG = 238,	 //0 0 1 
	ID_C_S_NULL_S_RATE = 239,	 //0 0 1 
	ID_D_S_NULL_S_DANG = 240,	 //0 0 1 
	ID_ABSOLUTE_COMP_TIME = 241,	 //0 0 1 
	ID_LV_START,	 //   
	ID_LV_CH_0,	 //   
	ID_LV_CH_1,	 //   
	ID_LV_CH_2,	 //   
