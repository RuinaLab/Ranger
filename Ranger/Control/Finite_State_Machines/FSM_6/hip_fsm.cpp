...
float hi_premid_counter;
float ho_premid_counter;
...
hi_premid_counter = hi_premid_counter + 2.0;

//if (get_io_float(ID_E_T_AFTER_HS)<=350.00)
//    {
     set_io_float(ID_MCH_COMMAND_CURRENT, 
               get_io_float(ID_A_H_PM_A0) 
               + 0.001*get_io_float(ID_A_H_PM_A1) * get_io_float(ID_E_T_AFTER_HS)
               );
 //   }
//else   
//    {
...
int ACT_HO_premid(void)
{
 ...
 ho_premid_counter = ho_premid_counter + 2.0;
...
fsm fsm1(numStates, STATE_HI_premid, numInputs);
...
fsm1.trans_def(STATE_HI_premid, COND_HI_premid_to_HO_premid, STATE_HO_premid);
fsm1.trans_def(STATE_HO_premid, COND_HO_premid_to_HI_premid, STATE_HI_premid);
