...
//	VICIntEnable |= (1<<VIC_EINT1); //Enable EINT1 (bit 15)
	...
	// ************ PRIORITY 2 ******************  
	//ADCI
//	VICVectAddr2 = (unsigned long)ae_isr;
//	VICVectCntl2 = (1<<5) | VIC_SPI0; //(1<<5) is interrupt enable bit; 18 is ADC
//	VICIntEnable |= (1<<VIC_SPI0); //Enable ADC interrupt (bit18)
