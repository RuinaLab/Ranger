...
fsm1.state_def(STATE_HI_preswing, ACT_HI_preswing_entry, ACT_HI_preswing, ACT_HI_preswing);
...
fsm1.state_def(STATE_HO_preswing, ACT_HO_preswing_entry, ACT_HO_preswing, ACT_HO_preswing);
