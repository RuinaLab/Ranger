...
// define the inputs
enum conditions {COND_UI_calibrate_to_standby, COND_UI_calibrate_to_walk, COND_UI_standby_to_walk, COND_UI_standby_to_calibrate,
                  COND_UI_walk_to_standby, COND_UI_walk_to_calibrate, COND_UI_stop};
