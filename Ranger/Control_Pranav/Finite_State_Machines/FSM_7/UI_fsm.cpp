...
fsm1.state_def(STATE_UI_standby, ACTION_UI_standby, ACTION_UI_standby, ACTION_UI_standby);
fsm1.state_def(STATE_UI_walk, ACTION_UI_walk, ACTION_UI_walk, ACTION_UI_walk);
...
fsm1.trans_def(STATE_UI_calibrate, COND_UI_calibrate_to_standby, STATE_UI_standby);
...
fsm1.trans_def(STATE_UI_walk, COND_UI_walk_to_calibrate, STATE_UI_calibrate);
