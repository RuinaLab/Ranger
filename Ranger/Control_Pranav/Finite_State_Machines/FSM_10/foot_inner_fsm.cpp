...
fsm1.state_def(STATE_FI_stopstance, ACT_FI_stopstance_entry, ACT_FI_stopstance, ACT_FI_stopstance); //Stop stance
fsm1.state_def(STATE_FI_startafterpush, ACT_FI_startafterpush_entry, ACT_FI_startafterpush, ACT_FI_startafterpush); //Start state
...
fsm1.trans_def(STATE_FI_stopstance, COND_FI_startflipdown, STATE_FI_startflipdown);
fsm1.trans_def(STATE_FI_startafterpush, COND_FI_startflipdown, STATE_FI_startflipdown);

fsm1.trans_def(STATE_FI_stance, COND_FI_stance_to_stopstance, STATE_FI_stopstance); //Stop stance transition 
fsm1.trans_def(STATE_FI_prepush, COND_FI_prepush_to_stopstance, STATE_FI_stopstance);

fsm1.trans_def(STATE_FI_stopstance, COND_FI_stopstance_to_startafterpush, STATE_FI_startafterpush); //Start in afterpush from stopping
