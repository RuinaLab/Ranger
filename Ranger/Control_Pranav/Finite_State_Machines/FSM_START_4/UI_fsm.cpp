...
fsm1.state_def(STATE_UI_rock, ACTION_UI_rock_entry, ACTION_UI_rock, ACTION_UI_rock);
...
fsm1.trans_def(STATE_UI_calibrate, COND_UI_calibrate_to_rock, STATE_UI_rock);
fsm1.trans_def(STATE_UI_standby, COND_UI_standby_to_rock, STATE_UI_rock);
fsm1.trans_def(STATE_UI_rock, COND_UI_rock_to_standby, STATE_UI_standby);
fsm1.trans_def(STATE_UI_rock, COND_UI_rock_to_walk, STATE_UI_walk);
