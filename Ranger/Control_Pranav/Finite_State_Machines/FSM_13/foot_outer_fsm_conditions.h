...
{}
 ...
 {
//if ( 
//    (get_io_float(ID_E_LO_ABSANG) > (get_io_float(ID_P_F_PP_L_ABSANG) ) )  //E_TEST set in hip actions
//              ||
//     ( (get_io_float(ID_MCFI_LEFT_HS) + get_io_float(ID_MCFI_RIGHT_HS) >= 1.0) && ((get_io_float(ID_MCH_ANGLE)) >0.05 ) ) 
//      )
if ( 
     ( (get_io_float(ID_E_SWING_F_HEIGHT) < get_io_float(ID_P_FO_PP_THEIGHT))
           // && ( get_io_float(ID_MCFI_MID_ANKLE_ANGLE) > get_io_float(ID_P_F_PP_F_ABSANG) )
