...
//      (get_io_float(ID_MCSO_LEFT_ANKLE_RATE) < -get_io_float(ID_P_H_PM_F_RATE) ) //Put back in once board is back on robot. 3/19/2011 Pranav
  ...
  if  ( (get_io_float(ID_MCFO_LEFT_HS) + get_io_float(ID_MCFO_RIGHT_HS)) >= 1.0) //CHANGE TO ID_E_SWING_LEG == 1 
 /* if ( 
  ...
  if ((get_io_float(ID_MCFI_LEFT_HS) + get_io_float(ID_MCFI_RIGHT_HS)) >= 1.0) //CHANGE TO ID_E_SWING_LEG == 0
  /*if (  
