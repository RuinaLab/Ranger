...
extern int g_ui_fsm_state;
extern int g_leg_fsm_state;
const float mb_time = 2; //main brain loop time. Runs once per 2 milli-second
extern int g_rock_hip_fsm_state;
extern int g_rock_foot_inner_fsm_state;
extern int g_rock_foot_outer_fsm_state;
