...
fsm1.state_def(STATE_FO_flipup, ACT_rock_FO_flipup_entry,ACT_rock_FO_flipup,ACT_rock_FO_flipup);
fsm1.state_def(STATE_FO_flipdown, ACT_rock_FO_flipdown_entry,ACT_rock_FO_flipdown,ACT_rock_FO_flipdown);
...
fsm1.trans_def(STATE_FO_flipdown, COND_FO_flipdown_to_flipup, STATE_FO_flipup);
