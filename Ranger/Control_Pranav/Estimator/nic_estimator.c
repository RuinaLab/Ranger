...
if ( reset_time_after_HS_flag == 1 ) // when the swing foot hits the gorund, setin leg_state_machine
    ...
    /**** SLOPE CALCULATIONS AND UPHILL CONTROL *******/
    walk_uphill();
    /**************************************************/
    }
...
//2) ankle angle is angle between leg-line and the line joining ankle joint to the centre of ceircle whose part is the foot. Its is positive when ankle is infront of leg (i.e. eg when foot isflipped down)
